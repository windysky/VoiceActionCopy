...
- Rick Strahl, "Using Windows.Media.SpeechRecognition in WPF"
- Microsoft Learn, "Enable continuous dictation"
- Handy (open source speech-to-text)
- asr2clip
- Windows Voice Access documentation
